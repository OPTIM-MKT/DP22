...
//  Design tokens (DP22 brand colors)
const BRAND = {
  primary: "#1c3766",   // Navy — brand primary
  shade: "#152b52",     // Navy dark
  secondary: "#d4ae2c", // Gold — brand secondary
  accent: "#fab702",    // Gold accent
  mateBlack: "#14223f",
  mateWhite: "#f7f6f2",
  surface: "#ffffff",
  surface2: "#f7f6f2",
...
export function EmailTemplate({
  ...
  const replySubject = encodeURIComponent(`Contacto desde dp22.mx`);
  ...
  return (
    <div style={s.wrapper}>
      <div style={s.card}>
        {/* ── Header ── */}
        <div style={s.header}>
          <div style={s.logoBadge}>DP22</div>
        ...
        <div style={s.body}>
          ...
          <div style={{ ...s.grid, marginBottom: 12 }}>
            ...
            <Field label="Teléfono" value={telefono || "No especificado"} />
          </div>
          ...
          <p style={s.sectionTitle}>Detalles</p>

          {interesLabel && (
            <div style={{ ...s.fieldBoxFull, marginBottom: 24 }}>
              <span style={s.fieldLabel}>Propiedad de interés</span>
              <span style={s.badge}>{interesLabel}</span>
            </div>
          )}
          ...
          {mensaje && (
            <div style={s.messageBox}>
              <span
                style={{ ...s.fieldLabel, color: BRAND.primary, marginBottom: 8 }}
              >
                Mensaje
              </span>
        ...
        <div style={s.footer}>
          <p style={s.footerText}>
            ...
            contacto de <strong>dp22.mx</strong>. Por favor no respondas
            directamente a este mensaje.
          </p>
          <p style={{ ...s.footerText, marginTop: 8 }}>
            © {new Date().getFullYear()} DP22 · Todos los derechos reservados
          </p>
        </div>
      </div>
    </div>
